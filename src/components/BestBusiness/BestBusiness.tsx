    ...
    <div className="relative px-6 py-20 md:py-64" id="features">
        ...
        <div className="grid max-w-5xl mx-auto md:grid-cols-2">
            <div>
                ...
                <Reveal>
                    <p className="mx-w-md mt-10">Con la tarjeta de crédito adecuada, puede mejorar su vida financiera generando crédito, obteniendo recompensas y ahorrando dinero. Pero con cientos de tarjetas de crédito en el mercado.</p>
                </Reveal>
                <Reveal>
                    <div className="my-8">
